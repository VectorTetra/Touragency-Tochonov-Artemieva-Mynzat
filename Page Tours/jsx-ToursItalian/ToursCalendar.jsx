        ...
        <div className="containerAll">
            <button className="prev">
                ...
                <React.Suspense fallback={<Loading width="60px" height="60px" />}>
                    <SuspenseImage src={props.data.buttons[0].imgSrcLeft} alt={props.data.buttons[0].imgAltLeft} />
                </React.Suspense>
            </button>
            ...
            <button className="next">
                ...
                <React.Suspense fallback={<Loading width="60px" height="60px" />}>
                    <SuspenseImage src={props.data.buttons[1].imgSrcRight} alt={props.data.buttons[1].imgAltRight} />
                </React.Suspense>
            </button>
        </div>
    );
